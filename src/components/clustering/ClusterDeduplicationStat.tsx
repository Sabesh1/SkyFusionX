...
export const ClusterDeduplicationStat: React.FC<{ cluster: ClusterDetail }> = ({ cluster }) => {
  return (
    <div className="p-6 rounded-2xl bg-theme-card border border-cyan-500/30 space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-5 rounded-xl bg-gradient-to-r from-slate-900 via-[#0B1426] to-slate-900 border border-theme-border">
        <div className="flex items-center gap-4 text-center sm:text-left">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-theme-text font-mono mt-0.5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
        <div className="p-3 rounded-lg bg-theme-surface/60 border border-theme-border">
          ...
          <p className="text-sm font-bold text-theme-text mt-0.5">{cluster.clusterRadiusKm} km</p>
        </div>
        <div className="p-3 rounded-lg bg-theme-surface/60 border border-theme-border">
          <span className="text-[10px] text-theme-muted uppercase">Active Window</span>
          <p className="text-sm font-bold text-cyan-400 mt-0.5">{cluster.activeWindowMinutes} mins</p>
        </div>
        <div className="p-3 rounded-lg bg-theme-surface/60 border border-theme-border">
          <span className="text-[10px] text-theme-muted uppercase">Confidence Score</span>
          <p className="text-sm font-bold text-emerald-400 mt-0.5">{cluster.trustScore}% Trust</p>
        </div>
        <div className="p-3 rounded-lg bg-theme-surface/60 border border-theme-border">
          <span className="text-[10px] text-theme-muted uppercase">Algorithm</span>
      ...
      <div className="space-y-2">
        ...
        <div className="w-full h-3 bg-theme-surface rounded-full overflow-hidden flex border border-theme-border">
          <div
        ...
        <div className="flex flex-wrap items-center gap-4 text-[11px] font-mono text-theme-muted pt-1">
