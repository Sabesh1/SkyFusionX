...
export const Globe: React.FC<GlobeProps> = ({ className = "", height }) => {
  return (
    <>
      <style>
        {`
      ...
      <div
        ...
        className={`flex items-center justify-center relative w-full overflow-hidden ${className || "h-[500px]"}`}
      >
        <div
          className="relative w-[260px] h-[260px] sm:w-[280px] sm:h-[280px] rounded-full overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.2),-5px_0_8px_#c3f4ff_inset,15px_2px_25px_#000_inset,-24px_-2px_34px_#c3f4ff99_inset,250px_0_44px_#00000066_inset,150px_0_38px_#000000aa_inset]"
          style={{
