      ...
      <div className="p-6 rounded-2xl bg-theme-card border border-theme-border space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 text-center font-mono text-xs">
          {[
            ...
            <div
              key={idx}
              className="p-2.5 rounded-lg bg-theme-surface/60 border border-theme-border space-y-1"
            >
              <div className="text-[9px] text-theme-muted uppercase font-bold">{item.step}</div>
