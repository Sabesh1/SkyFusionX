  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 p-6 rounded-2xl bg-theme-card border border-theme-border space-y-4">
        ...
        <div className="lg:col-span-4 p-6 rounded-2xl bg-theme-card border border-theme-border space-y-4">
          <div className="border-b border-theme-border pb-3">
            <h3 className="text-xs font-mono uppercase font-bold text-theme-text">
              Disaster Type Breakdown
            </h3>
            <p className="text-[11px] text-theme-muted mt-0.5">Active national risk categorization.</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[10px] font-mono text-theme-text">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 p-6 rounded-2xl bg-theme-card border border-theme-border space-y-4">
          <div className="border-b border-theme-border pb-3">
            ...
            <p className="text-[11px] text-theme-muted mt-0.5">Disaster clusters & citizen reports by state.</p>
          </div>
        ...
        <div className="lg:col-span-6 p-6 rounded-2xl bg-theme-card border border-theme-border space-y-4">
          <div className="border-b border-theme-border pb-3">
            ...
            <p className="text-[11px] text-theme-muted mt-0.5">Throughput volume & average source credibility.</p>
          </div>
