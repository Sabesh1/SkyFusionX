...
def seed_database():
    ...
    # All model_version=None so the real pipeline processes them fresh
    observations_data = [
        {"id": "REP-CHE-001", "source": "Citizen Mobile App", "source_event_id": "CIT-TN-01",
         ...
         "state": "Tamil Nadu", "event_type": "Urban Flooding", "severity": 4, "is_mock": True, "verification_status": "PROCESSING",
        ...
        {"id": "REP-BOM-001", "source": "Citizen Mobile App", "source_event_id": "CIT-MH-01",
         ...
         "state": "Maharashtra", "event_type": "Urban Flooding", "severity": 4, "is_mock": True, "verification_status": "PROCESSING",
        ...
        {"id": "REP-BLR-001", "source": "Municipal Sensor", "source_event_id": "SEN-KA-01",
         ...
         "state": "Karnataka", "event_type": "Thunderstorm", "severity": 3, "is_mock": True, "verification_status": "PROCESSING",
         "media_url": "https://images.unsplash.com/photo-1548232979-6c557ee14758?auto=format&fit=crop&w=800&q=80"
        },
