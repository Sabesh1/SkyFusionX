...
def seed_database():
    ...
    observations_data = [
        {"id": "REP-CHE-001", "source": "Citizen Mobile App", "source_event_id": "CIT-TN-01",
         ...
         "state": "Tamil Nadu", "event_type": "Urban Flooding", "severity": 4, "is_mock": True, "verification_status": "HIGH_CONFIDENCE",
         "trust_score": 94.0, "media_url": "https://images.unsplash.com/photo-1547683905-f686c993aae5?auto=format&fit=crop&w=800&q=80",
         "gemini_analyzed": True, "image_analyzed": True, "verification_assessment": "EVIDENCE_SUPPORTED",
         "gemini_evidence_json": '{"supporting": ["Extensive waterlogging visible", "Vehicles partially submerged"], "contradicting": [], "assessment": "EVIDENCE_SUPPORTED"}'
        },
        {"id": "REP-CBE-001", "source": "Citizen Mobile App", "source_event_id": "CIT-TN-03",
         ...
         "state": "Tamil Nadu", "event_type": "Urban Flooding", "severity": 3, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 85.0},
        {"id": "REP-HYD-001", "source": "Municipal Sensor", "source_event_id": "SEN-TS-01",
         ...
         "state": "Telangana", "event_type": "Urban Flooding", "severity": 3, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 92.0},
        {"id": "REP-MDU-001", "source": "Social Media", "source_event_id": "SOC-TN-02",
         ...
         "state": "Tamil Nadu", "event_type": "Thunderstorm", "severity": 3, "is_mock": True, "verification_status": "UNDER_REVIEW", "trust_score": 68.0},
        {"id": "REP-BOM-001", "source": "Citizen Mobile App", "source_event_id": "CIT-MH-01",
         ...
         "state": "Maharashtra", "event_type": "Urban Flooding", "severity": 4, "is_mock": True, "verification_status": "HIGH_CONFIDENCE",
         "trust_score": 96.0, "media_url": "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?auto=format&fit=crop&w=800&q=80",
         "gemini_analyzed": True, "image_analyzed": True, "verification_assessment": "EVIDENCE_SUPPORTED",
         "gemini_evidence_json": '{"supporting": ["Train tracks fully submerged", "Water level reaching platform edge"], "contradicting": [], "assessment": "EVIDENCE_SUPPORTED"}'
        },
        {"id": "REP-BLR-001", "source": "Municipal Sensor", "source_event_id": "SEN-KA-01",
         ...
         "state": "Karnataka", "event_type": "Thunderstorm", "severity": 3, "is_mock": True, "verification_status": "HIGH_CONFIDENCE",
         "trust_score": 88.0, "media_url": "https://images.unsplash.com/photo-1548232979-6c557ee14758?auto=format&fit=crop&w=800&q=80",
         "gemini_analyzed": True, "image_analyzed": True, "verification_assessment": "EVIDENCE_SUPPORTED",
         "gemini_evidence_json": '{"supporting": ["Waterlogging evident on road", "Traffic slowed due to inundation"], "contradicting": [], "assessment": "EVIDENCE_SUPPORTED"}'
        },
        {"id": "REP-VAGUE-001", "source": "Social Media", "source_event_id": "SOC-VAGUE-01",
         ...
         "state": "Tamil Nadu", "event_type": "OTHER", "severity": 1, "is_mock": True, "verification_status": "UNVERIFIED", "trust_score": 35.0},
        {"id": "REP-SUSP-001", "source": "Social Media", "source_event_id": "SOC-FAKE-01",
         ...
         "state": "Tamil Nadu", "event_type": "OTHER", "severity": 4, "is_mock": True, "verification_status": "REJECTED", "trust_score": 12.0},
        {"id": "REP-DEL-001", "source": "Citizen Mobile App", "source_event_id": "CIT-DL-01",
         ...
         "state": "Delhi", "event_type": "OTHER", "severity": 3, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 90.0},
        {"id": "REP-PUN-001", "source": "Citizen Mobile App", "source_event_id": "CIT-MH-02",
         ...
         "state": "Maharashtra", "event_type": "OTHER", "severity": 3, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 87.0},
        {"id": "REP-CHE-002", "source": "Social Media", "source_event_id": "SOC-TN-CHE-02",
         ...
         "state": "Tamil Nadu", "event_type": "OTHER", "severity": 3, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 82.0},
        {"id": "REP-NORM-001", "source": "Citizen Mobile App", "source_event_id": "CIT-NORM-01",
         ...
         "state": "Tamil Nadu", "event_type": "OTHER", "severity": 1, "is_mock": True, "verification_status": "VERIFIED", "trust_score": 75.0},
    ]
