...
def seed_database():
    ...
    observations_data = [
        ...
        {"id": "REP-CBE-001", "source": "Citizen Mobile App", "source_event_id": "CIT-TN-03",
         ...
         "state": "Tamil Nadu", "event_type": "Urban Flooding", "severity": 3, "is_mock": True, "verification_status": "PROCESSING"},
        {"id": "REP-HYD-001", "source": "Municipal Sensor", "source_event_id": "SEN-TS-01",
         ...
         "state": "Telangana", "event_type": "Urban Flooding", "severity": 3, "is_mock": True, "verification_status": "PROCESSING"},
        {"id": "REP-MDU-001", "source": "Social Media", "source_event_id": "SOC-TN-02",
         ...
         "state": "Tamil Nadu", "event_type": "Thunderstorm", "severity": 3, "is_mock": True, "verification_status": "PROCESSING"},
